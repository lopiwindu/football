  ...
  const handleConfirmBet = (): void => {
    ...
    if (selectedPrediction && amount > 0 && amount <= userBalance) {
      ...
      toast.success("Bet Placed!", {
        description: `$${amount} on ${getPredictionLabel()}`,
      });
      ...
      <Card className="bg-slate-800 border-slate-700 hover:border-blue-500/50 transition-all duration-200">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            {isWalletConnected && userTotalBetOnMatch > 0 && (
              <div className="flex items-center justify-between text-sm p-2 bg-blue-500/10 border border-blue-500/20 rounded-md">
                <div className="flex items-center gap-2 text-blue-400">
                  <DollarSign className="w-4 h-4" />
                  <span>Your Total Bet:</span>
                </div>
                <span className="text-blue-300 font-bold">
                  ${userTotalBetOnMatch.toLocaleString()}
                </span>
              </div>
            )}
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-md">
                ...
                <p className="text-sm text-slate-400">
                  Odds: {getSelectedOdds().toFixed(2)}x
                </p>
              </div>
            </div>
